...
void Init_trenni() {
	...
	rb_define_module_function(rb_Trenni_Native, "append_tag", Trenni_Native_append_tag, 4);
	rb_define_module_function(rb_Trenni_Native, "format_tag", Trenni_Native_format_tag, 3);
