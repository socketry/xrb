...
const char * index_symbol(const char * begin, const char * end) {
	const char * p = begin;
...
VALUE Trenni_Native_escape_markup(VALUE self, VALUE string) {
	...
	// We allocate the string to contain the source string + some extra capacity:
